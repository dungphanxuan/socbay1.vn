    ...
    <div class="col-md-3">
        ...
        <div class="box box-primary">
            <div class="box-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo ucfirst(Yii::$app->user->identity->username) ?></h3>
                        ...
                        <div class="row margin-bottom">
                            <div class="col-sm-6">
                                <img class="img-responsive"
                                     src="https://adminlte.io/themes/AdminLTE/dist/img/photo1.png" alt="Photo">
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <br>
                                        <img class="img-responsive"
                                             src="https://adminlte.io/themes/AdminLTE/dist/img/photo3.jpg" alt="Photo">
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-sm-6">
                                        <img class="img-responsive"
                                             src="https://adminlte.io/themes/AdminLTE/dist/img/photo4.jpg" alt="Photo">
                                        <br>
                                        <img class="img-responsive"
                                             src="https://adminlte.io/themes/AdminLTE/dist/img/photo1.png" alt="Photo">
                                    </div>
