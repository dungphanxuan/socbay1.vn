...
<section>
    <div class="container">
        ...
        <div class="details clearfix">
            <div class="center">
                <h1>Phiếu hạch toán</h1>
            </div>
        </div>
        <p style="margin-bottom: 10px;"><b>Khách hàng</b></p>
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 20px;">
            <tbody>
            <tr>
                <td>Khách hàng</td>
                <td>Đồng Thị Dương</td>
                <td>Biển số xe</td>
                <td>34K-1183</td>
            </tr>
            <tr>
                <td>Địa chỉ</td>
                <td>B11 - 280 Hồ Tùng Mậu, Bắc Từ Liêm, Hà Nội</td>
                <td>Kiểu xe</td>
                <td>Camry 2.4Q</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Email</td>
                <td><a href="mailto:duong@gmail.com">duong@gmail.com</a></td>
                <td>Số khung</td>
                <td>HC82845383</td>
            </tr>
            <tr>
        ...
        <p style="margin-bottom: 10px;"><b>Chi tiết lệnh sửa chữa</b></p>
        <table border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 20px;">
            <tbody>
            <tr>
            ...
            <tr>
                <td style="width: 33.33%">Loại sửa chữa</td>
                <td>Thay mới</td>
            </tr>
            <tr>
                <td>Người lập lệnh sửa chữa</td>
                <td>Trần Thị Vân</td>
            </tr>
            <tr>
                <td>Kỹ thuật viên</td>
                <td>Phan Xuân Dũng</td>
            </tr>
            <tr>
        ...
        <div class="details">
            <p><b>Bằng chữ: </b>Hai triệu năm trăm tám mươi ba nghìn đồng</p>
