...
<section>
    <div class="container">
        ...
        <div class="details clearfix head-2-col">
            <div class="center">
                <h1 style="margin-bottom: 20px;">Phiếu xuất kho</h1>
                <p>
                    <span>Ngày 05 Tháng 04 năm 2017</span>
                    <span>Số 100</span>
                </p>
                <p>
                    <span>Nợ 621</span>
        ...
        <div class="details">
            <p>
                <span>- Họ tên người giao: Nguyễn Việt Tiến</span>
            </p>
            <p>
                <span>- Nhập kho tại: Công ty</span>
            </p>
            <p>
                <span>- Địa điểm: 168 Phan Trọng Tuệ, Thanh Liệt, Hà Nội</span>
            </p>
        </div>
        <p style="display: block;margin-bottom: 20px;"><b>Thông tin hàng hóa</b></p>
        <table class="center" border="0" cellspacing="0" cellpadding="0">
            <tbody>
            <tr class="bold">
                <td rowspan="2">STT</td>
                <td rowspan="2">Mã</td>
                <td rowspan="2">Tên phụ tùng</td>
                <td rowspan="2">ĐVT</td>
            ...
            <tr>
                <td>2</td>
                <td>123456</td>
                <td>Đèn pha Honda Civic 1.8 2017</td>
                <td>Cái</td>
                <td>700.000</td>
                <td>15</td>
                <td>15</td>
            ...
            <tr>
                <td>3</td>
                <td>3214569</td>
                <td>Gương chiếu hậu RAV4 2008</td>
                <td>Cái</td>
                <td>1.000.000</td>
                <td>30</td>
                <td>30</td>
            ...
            <tr class="bold">
                ...
                <td colspan="4" style="text-align: right;">6.510.000</td>
            </tr>
            </tbody>
        </table>
        <div class="no-break has-border">
            <table class="grand-total" style="margin-bottom: 0px;">
                <tbody>
                <tr>
        ...
        <div class="details">
            <p><b>Bằng chữ: Sáu triệu ba lăm nghìn năm trăm đồng</b></p>
            <p><b>Số chứng từ gốc kèm theo: 02</b></p>
