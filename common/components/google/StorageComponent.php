...
class StorageComponent extends Component
{
    ...
    {
        parent::init();
        $keyFilePath = getStoragePath() . '\key\CenturyEstate-cb4d9d54a79d.json';
     ...
     * @return bool|string
     */
    public function upload($file, $preserveFileName = false, $pathFile = null)
    {
        ...
        $filePath = implode('/', [1, date('mY'), $pathName]);
