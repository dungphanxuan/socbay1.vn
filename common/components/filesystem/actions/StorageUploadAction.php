...
class StorageUploadAction extends UploadAction
{
    ...
    public $base_url = 'https://storage.googleapis.com/century-estate.appspot.com';
        ...
        foreach ($uploadedFiles as $uploadedFile) {
            ...
            if ($uploadedFile->error === UPLOAD_ERR_OK) {
                ...
                if (!$validationModel->hasErrors()) {
                    ...
                    if ($path) {
                        //Backup File Server Hosting
                        //$this->getFileStorage()->save($uploadedFile, false, false, [], $path);
