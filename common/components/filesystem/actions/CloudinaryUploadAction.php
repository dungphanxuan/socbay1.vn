...
class CloudinaryUploadAction extends UploadAction
{
    ...
    public $base_url = 'https://res.cloudinary.com/dfeqcehdw/image/upload';
        ...
        foreach ($uploadedFiles as $uploadedFile) {
            ...
            if ($uploadedFile->error === UPLOAD_ERR_OK) {
                ...
                if (!$validationModel->hasErrors()) {
                    ...
                    $path = Yii::$app->cloudinary->upload($uploadedFile, [], $this->base_url);
