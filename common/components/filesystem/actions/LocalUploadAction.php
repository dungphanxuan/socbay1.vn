 ...
 *   }
 */
class LocalUploadAction extends \trntv\filekit\actions\UploadAction
{
        ...
        foreach ($uploadedFiles as $uploadedFile) {
            ...
            if ($uploadedFile->error === UPLOAD_ERR_OK) {
                ...
                if (!$validationModel->hasErrors()) {
                    ...
                    if ($path) {
                        //backup file
                        //$pathCloud =Yii::$app->cloudStorage->upload($uploadedFile, false, $path);
                        //$pathFileStack = Yii::$app->fileStack->upload($uploadedFile);
                        //Cloudinary
