...
return [
    ...
    'You have {num} log items' => '{num} Log item',
    ...
    'You have new article!' => 'Bài viết mới',
    'New article ({title}) was published at {created_at}' => 'Bài viết ({title}) được xuất bản lúc {created_at}',

    'View Article' => 'Xem bài viết',
    'Show Article' => 'Hiển thị bài viết',
    'View' => 'Xem',
];
