...
/**
 * AdsAssetsSearch represents the model behind the search form about `common\models\ads\AdsAssets`.
 */
class AdsAssetsSearch extends AdsAssets
{
    /**
     * @inheritdoc
     */
