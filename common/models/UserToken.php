...
class UserToken extends ActiveRecord
{
    ...
    const TYPE_PHONE_ACTIVATION = 'phone_activation';
    const TYPE_PASSWORD_RESET = 'password_reset';
    const TYPE_LOGIN_PASS = 'login_pass';
    const TOKEN_LENGTH = 40;
    const TYPE_USER_API = 'login_api';
    ...
    {
        $model = new self;
        $tokenGenerate = Yii::$app->security->generateRandomString(self::TOKEN_LENGTH);
        if ($type == UserToken::TYPE_PHONE_ACTIVATION) {
            //Otp Code Generate
            $tokenGenerate = '';
        }
