...
/**
 * ProjectCategorySearch represents the model behind the search form about `common\models\property\ProjectCategory`.
 */
class ProjectCategorySearch extends ProjectCategory
{
    ...
    {
        return [
            [['id', 'parent_id', 'total', 'sort_number', 'type', 'status', 'created_at', 'updated_at'], 'integer'],
...
// bypass scenarios() implementation in the parent class
    ...
    {
        $query = ProjectCategory::find()->orderBy('sort_number asc');
