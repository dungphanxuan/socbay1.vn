...
class SignupForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            //[['password'], StrengthValidator::class, 'preset' => 'strong', 'userAttribute' => 'username'],
            [['password'], StrengthValidator::class, 'preset' => StrengthValidator::SIMPLE, 'userAttribute' => 'username'],
