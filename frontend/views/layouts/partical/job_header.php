            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-left">
                    <li class="nav-item"><a class="nav-link"
                                            href="<?php echo Url::to(['/job/index']) ?>"><?php echo Yii::t('ads', 'Browse Jobs') ?></a>
                    </li>
                    <li class="nav-item"><a class="nav-link"
                                            href="<?php echo Url::to(['/jobc/company/index']) ?>"><?php echo Yii::t('ads', 'Company') ?></a>
                    </li>
                    <li class="nav-item"><a class="nav-link"
                                            href="<?php echo Url::to(['/job/resume']) ?>"><?php echo Yii::t('ads', 'Add Resume') ?></a>
                    </li>
                ...
                <ul class="nav navbar-nav ml-auto navbar-right">
                    ...
                    <?php else: ?>
                        <li class="nav-item"><a href="<?php echo Url::to(['/ads/index', 'cslug' => $jobCat['slug']]) ?>"
                                                class="nav-link"><i
                                        class="icon-th-thumb"></i> <?php echo Yii::t('ads', 'All Jobs') ?></a>
                        </li>
