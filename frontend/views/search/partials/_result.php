...
<div class="search-result">
    <div class="row">
        <div class="col-sm-12">
            <h3>
                <a href="<?php echo Url::to($model->getUrl()) ?>" class="title"><?php
                    ...
                    ?></a>
                <a href="<?php echo Url::to($model->getUrl()) ?>"
                   class="label label-warning"><?php echo $model->type ?></a>
                <a href="<?php echo Url::to($model->getUrl()) ?>"
                   class="label label-info"><?php echo $model->version ?></a>
                <?php if (isset($model->language)): ?>
                    <a href="<?php echo Url::to($model->getUrl()) ?>"
                       class="label label-success"><?php echo $model->language ?></a>
                <?php endif; ?>
            </h3>
            <?php
