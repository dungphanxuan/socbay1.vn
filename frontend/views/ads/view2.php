                        ...
                        <div class="ads-image ads-img-v2">
                            <div class="img-slider-box">
                                <div class="slider-left">
                                    <ul class="bxslider">
                                        <li>
                                            <img src="<?php echo $this->assetManager->getAssetUrl($bundle, 'images/item/tp-big/Image00014.jpg') ?>"
                                                 alt="img"/></li>
                                        <li>
                                            <img src="<?php echo $this->assetManager->getAssetUrl($bundle, 'images/item/tp-big/Image00015.jpg') ?>"
                                                 alt="img"/></li>
                                        <li>
                                            <img src="<?php echo $this->assetManager->getAssetUrl($bundle, 'images/item/tp-big/Image00013.jpg') ?>"
                                                 alt="img"/></li>
                                    </ul>
                                </div>
                                <div id="bx-pager" class="scrollbar">
                                    ...
                                    <a class="thumb-item-link" data-slide-index="1" href=""><img
                                                src="<?php echo $this->assetManager->getAssetUrl($bundle, 'images/item/tp/Image00015.jpg') ?>"
                                                alt="img"/></a>
                                    <a class="thumb-item-link" data-slide-index="2" href=""><img
                                                src="<?php echo $this->assetManager->getAssetUrl($bundle, 'images/item/tp/Image00013.jpg') ?>"
                                                alt="img"/></a>
                                ...
                                <div class="col-md-4">
                                    <aside class="panel panel-body panel-details">
                                        <ul>
                                            ...
                                            <li>
                                                <p class="no-margin"><strong>Location:</strong> Hà Nội </p>
                                            </li>
                                            <li>
                            ...
                            <div class="panel-content user-info">
                                <div class="panel-body text-center">
                                    <div class="seller-info">
                                        ...
                                        <p>Location: <strong>Hà Nội</strong></p>
