    ...
    <div class="card card-event info-overlay">
        <div class="img has-background"
            ...
            <a href="<?php echo Url::to(['/ads/view', 'id' => $model->id, 'name' => $model->slug]) ?>">
                <img alt="340x230" class="card-img-top img-responsive" data-holder-rendered="true"
                     src="<?php echo $this->assetManager->getAssetUrl($bundle, 'images/10x6.gif') ?>">
            </a>
        </div>
        <div class="card-body">
            <h4 class="card-title">
                <a href="<?php echo Url::to(['/ads/view', 'id' => $model->id, 'name' => $model->slug]) ?>">
                    <?php echo StringHelper::truncateWords($model->title, 15) ?></a>
            </h4>
        ...
        <div class="card-footer">
            <div class="pull-left left">
                <div class="">by <a
                            href="<?php echo Url::to(['/ads/view', 'id' => $model->id, 'name' => $model->slug]) ?>">Parrish
                        Zamora </a></div>
            </div>
